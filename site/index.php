                ...
                <div class="carousel-item active carousel-max-height">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 1100px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4">Lets Build Your Dream Together</h1>
                            <p data-animation="fadeInUp" data-delay="">We work step by step with you in your IT transformation journey. We thoroughly go through your IT requirements we don't apply a one size fits all approach.
                            ...
                            <a href="html/contact.html" class="btn btn-secondary py-md-3 px-md-5 rounded-pill">Please Contact Us</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item carousel-max-height">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 1100px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4">Your Leading Digital Transformation Expert in Africa</h1>
                            <p data-animation="fadeInUp" data-delay="">We understand that navigating into todays technology climate can be bit frustrating, especially within the digital transformation industry and key distinction required for it to be successful.
                ...
                <div class="h-100 d-flex flex-column justify-content-center bg-primary p-5">
                    <div class="d-flex text-white mb-5">
                        ...
                        <div class="ps-4">
                            ...
                            <p class="mb-0">As MARYTECHENOCK SOLUTIONS we help you identifying business needs and we will help you to determine the right solutions to your business problems.</p>
                        </div>
                    </div>
                    <div class="d-flex text-white mb-5">
                        <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-white text-primary rounded-circle mx-auto mb-4" style="width: 60px; height: 60px;">
                        ...
                        <div class="ps-4">
                            ...
                            <p class="mb-0">As system analyst and designers we evaluate and analyse particular business situations and develop ways of improving them through more optimal methods</p>
                        </div>
                    </div>
    ...
    <div class="container-fluid pt-6 px-5">
        ...
        <div class="row g-5">
            <div style="position: absolute; z-index: -20;  margin-left:-25px; margin-bottom: 35px;">
                <img src="./img/bee.png" alt="Image" style="height:885px; width:100%;">
            </div>
            <div class="col-lg-4 col-md-6" style="margin-bottom: 5px;">
                <div class="service-item bg-secondary text-center px-3" style="margin-top: 10px;">
            ...
            <div class="col-lg-4 col-md-6" style="margin-bottom: 5px;">
                <div class="service-item bg-secondary text-center px-3" style="margin-top: 10px;">
                    ...
                    <p class="mb-0">Many of our clients come to us saying they need a specific type of system only to find out that it won’t solve their problem. We offer clients business technology advice to identify their needs and the best solution to reach their end goal.</p>
                    ...
                    <div class="col-lg-6 py-6 px-5">
                        ...
                        <form>
                            <div class="row gx-3">
                                ...
                                <div class="col-6">
                                    <button class="btn btn-primary w-100 h-100" type="submit">Request A Free Quote</button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="blog-item">
                            ...
                            <div class="bg-secondary d-flex">
                                <div class="flex-shrink-0 d-flex flex-column justify-content-center text-center bg-primary text-white px-4">
                                    <span>Get</span>
                                    <h5 class="text-uppercase m-0">Certified</h4>
                                        <span>with Us</span>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="blog-item">
                            ...
                            <div class="bg-secondary d-flex">
                                <div class="flex-shrink-0 d-flex flex-column justify-content-center text-center bg-primary text-white px-4">
                                    <span>Get</span>
                                    <h5 class="text-uppercase m-0">Certified</h5>
                                    <span>with us</span>
                                </div>
                                <div class="d-flex flex-column justify-content-center py-3 px-4">
                                    <div class="d-flex mb-2">
                    ...
                    <div class="col-lg-4">
                        <div class="blog-item">
                            ...
                            <div class="bg-secondary d-flex">
                                <div class="flex-shrink-0 d-flex flex-column justify-content-center text-center bg-primary text-white px-4">
                                    <span>Starts</span>
                                    <h5 class="text-uppercase m-0">Jan</h4>
                                        <span>2024</span>
                                </div>
                                <div class="d-flex flex-column justify-content-center py-3 px-4">
                                    <div class="d-flex mb-2">
            ...
            <div class="container-fluid bg-dark text-secondary text-center border-top py-4 px-5" style="border-color: rgba(256, 256, 256, .1) !important;">
                <p class="m-0">&copy; <a class="text-secondary border-bottom" href="#">2023 MARYTECHENOCK SOLUTIONS</a>. All Rights Reserved.<a class="text-secondary border-bottom" href></a></p>
            </div>
            <!-- Footer End -->
